<?php
/**
 * Nora Learn override for Tutor LMS loop cards.
 *
...
do_action( 'nora_learn_tutor/loop/before_course_card', get_the_ID() );
get_template_part( 'template-parts/cards/course-card' );
do_action( 'nora_learn_tutor/loop/after_course_card', get_the_ID() );