 ...
 * per push to `main`. Each release attaches a ready-to-install `nora-learn.zip`
 ...
 */
function nora_learn_init_updater() {
	$lib    = NORA_LEARN_DIR . '/inc/lib/plugin-update-checker';
	...
	$checker = $factory::buildUpdateChecker(
		'https://github.com/wachiravit-thitagran/AINora-WPTheme/',
		NORA_LEARN_DIR . '/style.css', // Theme mode: PUC reads the Version header here.
		'nora-learn'
	);
	...
	if ( $api && method_exists( $api, 'enableReleaseAssets' ) ) {
		$api->enableReleaseAssets( '/nora-learn\.zip$/' );
	}
}
add_action( 'after_setup_theme', 'nora_learn_init_updater' );
