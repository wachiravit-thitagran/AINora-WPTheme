...
nora_learn_page_hero(
	array(
		'eyebrow'    => __( 'ค้นหา', 'nora-learn' ),
		/* translators: %s: search term */
		'title'      => sprintf( __( 'ผลการค้นหา “%s”', 'nora-learn' ), esc_html( get_search_query() ) ),
		/* translators: %d: result count */
		'subtitle'   => sprintf( _n( 'พบ %d รายการ', 'พบ %d รายการ', $count, 'nora-learn' ), $count ),
		'breadcrumb' => false,
	)
);
?>
